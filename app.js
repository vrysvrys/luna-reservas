...
function renderFloorPlan() {
  ...
  document.getElementById("details-panel").innerHTML = mesaSeleccionada ? renderMesaDetalle(mesaSeleccionada) : "<p>Selecciona una mesa para ver/gestionar reserva.</p>";
}
...
function renderMesaDetalle(mesa) {
  const r = reservasData[mesa.id];
  return r && r.nombre ? `<div class="detail-panel">
